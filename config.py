...
PLUGIN_FIX_MENUS = OrderedDict([
       ...
       ('check_fix_book_paths',     {'name': _('Check and rename book paths'),   'cat':'fix',  'group': 1, 'image': 'images/fix_rename.png',          'tooltip':_('Ensure db path is correctly generated from author and title')}),
       ('check_fix_book_paths_cases',     {'name': _('Check and re-case book paths'),   'cat':'fix',  'group': 1, 'image': 'images/fix_rename.png',          'tooltip':_('Ensure fs path matches the db path')}),
